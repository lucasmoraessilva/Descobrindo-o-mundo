...
public class JogoNivel03 extends AppCompatActivity {
        ...
        palavraCall.enqueue(new Callback<Palavra>() {
            ...
            public void onResponse(Call<Palavra> call, Response<Palavra> response) {
                if (!response.isSuccessful()){
                    ...
                    btn_jogo_nivel_03_verificar.setOnClickListener(new MyOnClickListenerBtnVerificar(usuario, response.body().getId(), tentativas, horaInicial));
        ...
        public void onClick(View view) {
            ...
            if(child1 == 1 && child2 == 1 && child3 == 1 && child4 == 1){
                ...
                if (valorFinal.equals(palavraCorreta)){
                    ...
                    Partida partidaVitoria = new Partida(1,usuario.getPaciente().getId(),IdPalavra,dataFinal,duracaoFinal,"v", Tentativas,1);
    ...
    private void AdicionarImagem(String nomePalavra){
        ImageView iv_jogo_nivel_03 = findViewById(R.id.iv_jogo_nivel_03);
        switch (nomePalavra){
            case "ABACAXI":
                iv_jogo_nivel_03.setImageResource(R.drawable.abacaxi);
                break;
            case "ABACATE":
                iv_jogo_nivel_03.setImageResource(R.drawable.abacate);
                break;
            case "MELANCIA":
                iv_jogo_nivel_03.setImageResource(R.drawable.melancia);
                break;
        }
    }
}