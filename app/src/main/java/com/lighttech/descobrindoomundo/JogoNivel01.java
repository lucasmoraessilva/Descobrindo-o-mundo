...
public class JogoNivel01 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final LinearLayout ll_jogo_nivel_01_encaixes = findViewById(R.id.ll_jogo_nivel_01_encaixes);
        final LinearLayout ll_jogo_nivel_01_encaixe_01 = findViewById(R.id.ll_jogo_nivel_01_encaixe_01);
        final LinearLayout ll_jogo_nivel_01_encaixe_02 = findViewById(R.id.ll_jogo_nivel_01_encaixe_02);
        final LinearLayout ll_jogo_nivel_01_silabas = findViewById(R.id.ll_jogo_nivel_01_silabas);
        final TextView tv_jogo_nivel_01_slb_01 = findViewById(R.id.tv_jogo_nivel_01_slb_01);
        final TextView tv_jogo_nivel_01_slb_02 = findViewById(R.id.tv_jogo_nivel_01_slb_02);
        final TextView tv_jogo_nivel_01_slb_03 = findViewById(R.id.tv_jogo_nivel_01_slb_03);
        final TextView tv_jogo_nivel_01_slb_04 = findViewById(R.id.tv_jogo_nivel_01_slb_04);
        final Button btn_jogo_nivel_01_verificar = findViewById(R.id.btn_jogo_nivel_01_verificar);
        final Button btn_jogo_nivel_01_ajuda = findViewById(R.id.btn_jogo_nivel_01_ajuda);
        final Button btn_jogo_nivel_01_desistir = findViewById(R.id.btn_jogo_nivel_01_desistir);

        tv_jogo_nivel_01_slb_01.setOnLongClickListener(new MyOnLongClickListener());
        tv_jogo_nivel_01_slb_02.setOnLongClickListener(new MyOnLongClickListener());
        tv_jogo_nivel_01_slb_03.setOnLongClickListener(new MyOnLongClickListener());
        tv_jogo_nivel_01_slb_04.setOnLongClickListener(new MyOnLongClickListener());

        ll_jogo_nivel_01_encaixe_01.setOnDragListener(new MyOnDragListenerReceptor());
        ll_jogo_nivel_01_encaixe_02.setOnDragListener(new MyOnDragListenerReceptor());
        fl_jogo_nivel_01.setOnDragListener(new MyOnDragListenerFrameLayout());

        final Palavra palavra = new Palavra();
        Call<Palavra> palavraCall = palavra.buscar(1);

        palavraCall.enqueue(new Callback<Palavra>() {
            @Override
            public void onResponse(Call<Palavra> call, final Response<Palavra> response) {
                ...
                tv_jogo_nivel_01_slb_01.setText(silabasCorretas[0]);
                tv_jogo_nivel_01_slb_02.setText(silabasIncorretas[0]);
                tv_jogo_nivel_01_slb_03.setText(silabasCorretas[1]);
                tv_jogo_nivel_01_slb_04.setText(silabasIncorretas[1]);
            }
        ...
        btn_jogo_nivel_01_ajuda.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                int child1 = ll_jogo_nivel_01_encaixe_01.getChildCount();
                if(child1 != 1){
                    ll_jogo_nivel_01_silabas.removeView(tv_jogo_nivel_01_slb_01);
                    ll_jogo_nivel_01_encaixe_01.addView(tv_jogo_nivel_01_slb_01);
                    btn_jogo_nivel_01_ajuda.setEnabled(false);
                    tv_jogo_nivel_01_slb_01.setLongClickable(false);
                }
                else{
                    ll_jogo_nivel_01_silabas.removeView(tv_jogo_nivel_01_slb_03);
                    ll_jogo_nivel_01_encaixe_02.addView(tv_jogo_nivel_01_slb_03);
                    btn_jogo_nivel_01_ajuda.setEnabled(false);
                    tv_jogo_nivel_01_slb_03.setLongClickable(false);
                }
            }
        });
    }
        ...
        public boolean onDrag(View view, DragEvent dragEvent) {
            ...
            switch (action){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    ViewGroup owner = (ViewGroup) v.getParent();
                    owner.removeView(v);
                    LinearLayout container = findViewById(R.id.ll_jogo_nivel_01_silabas);
                    container.addView(v);
                    v.setVisibility(View.VISIBLE);
                    break;
                case DragEvent.ACTION_DRAG_ENDED:
    ...
    class MyOnClickListenerBtnVerificar implements View.OnClickListener {
        ...
        public MyOnClickListenerBtnVerificar(final Usuario usuario, int idPalavra, int tentativas, LocalTime dataInicial){
            ...
            Button btn_jogo_nivel_01_desistir = findViewById(R.id.btn_jogo_nivel_01_desistir);
        ...
        public void onClick(View view) {
            int child1 = ll_jogo_nivel_01_encaixe_01.getChildCount();
            int child2 = ll_jogo_nivel_01_encaixe_02.getChildCount();

            if(child1 == 1 && child2 == 1){
                TextView tv1 = (TextView) ll_jogo_nivel_01_encaixe_01.getChildAt(0);
                TextView tv2 = (TextView) ll_jogo_nivel_01_encaixe_02.getChildAt(0);

                String palavraCorreta = tv_jogo_nivel_01_slb_01.getText().toString() + tv_jogo_nivel_01_slb_03.getText().toString();
                String valorFinal = tv1.getText().toString() + tv2.getText().toString();
    ...
    private void AdicionarImagem(String nomePalavra){
        ImageView iv_jogo_nivel_01 = findViewById(R.id.iv_jogo_nivel_01);
        switch (nomePalavra){
            case "LIMÃO":
                iv_jogo_nivel_01.setImageResource(R.drawable.limao);
                break;
            case "MAÇÃ":
                iv_jogo_nivel_01.setImageResource(R.drawable.maca);
                break;
            case "PERA":
                iv_jogo_nivel_01.setImageResource(R.drawable.pera);
                break;
        }
    }
}